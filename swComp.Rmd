...
ggplot(data = div.comp, aes(sw.plantcalc, sw.pancalc, col = Site))+ geom_point(size = 2) + geom_smooth(method=lm) + labs(title = "Pan traps") + xlab("Diversity of Plants") + ylab("Insects Diversity in Pan traps")
```
...
ggplot(data = div.comp, aes(sw.plantcalc, sw.sweepcalc, col = Site))+ geom_point(size = 2) + geom_smooth(method=lm)+ labs(title = "Sweep survey") + xlab("Diversity of Plants") + ylab("Insects Diversity in Sweep survey")
```
